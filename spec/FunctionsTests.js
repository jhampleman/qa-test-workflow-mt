...
describe("Testing UI with jasmine", function() {
    ...
    it("gets Hello! from the div by div ID", function() {
      ...
      it("Buttons should have Aria label", ()=> {
        //var element = document.querySelectorAll('[aria-label]');
        
        var arrayLength = document.getElementsByTagName('button').length;
        
        for (var i = 0; i < arrayLength; i++) {
            //console.log(arrayLength);
        expect(document.getElementsByTagName('button')[i].getAttribute('aria-label')).toContain("");
